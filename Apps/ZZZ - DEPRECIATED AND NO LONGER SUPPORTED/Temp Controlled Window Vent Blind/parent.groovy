/**
 *  Design Usage:
 *  This is the 'Parent' app for Temp Controlled Window/Vent 
 *
 *
...
definition(
    name:"Temperature Controlled Window-Vent-Blind",
    namespace: "Cobra",
    author: "Andrew Parker",
    description: "Parent App for Temperature Controlled Window/Vent/Bind ChildApps ",
...
if(state.appInstalled == 'COMPLETE'){
  ...
  section (""){
		app(name: "tempWindowVentApp", appName: "Temperature Controlled Window-Vent-Blind Child", namespace: "Cobra", title: "<b>Add a new automation</b>", multiple: true)
            }
...
def installCheck(){         
  ...
  if(state.appInstalled != 'COMPLETE'){
section{paragraph "Please hit 'Done' to install Temperature Controlled Window/Vent/Bind"}
  }
    else{
...
def setVersion(){
		state.version = "2.0.0"	 
		state.InternalName = "TempControlledWindowParent" 
    	state.ExternalName = "Temperature Controlled Window-Vent-Blind Parent"
}
