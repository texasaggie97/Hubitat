/**
 *  Design Usage:
 *  This is the 'Parent' app for 'Daily Window Event' 
 *
 *
...
definition(
    name:"Daily Window Event",
    namespace: "Cobra",
    author: "Andrew Parker",
    description: "Parent App for 'Daily Window Event' childapps ",
...
if(state.appInstalled == 'COMPLETE'){
  ...
  section (""){
		app(name: "dailyWindowEventChild", appName: "Daily Window Event Child", namespace: "Cobra", title: "<b>Add a new automation</b>", multiple: true)
            }
...
def installCheck(){         
  ...
  if(state.appInstalled != 'COMPLETE'){
section{paragraph "Please hit 'Done' to install Daily Window Event"}
  }
    else{
