/**
 *  Design Usage:
 *  This is the 'Parent' app for Switch Changeover
 *
 *
...
definition(
    ...
    description: "Parent App for switch changeover ChildApps ",
...
def mainPage() {
	...
	display()
	section (){app(name: "changeoverApp", appName: "Switch Changeover Child", namespace: "Cobra", title: "<b>Add a new automation</b>", multiple: true)}
	displayDisable()
	}
  }
}
...
def setVersion(){
		state.version = "1.2.0"	 
		state.InternalName = "SwitchChangeOverParent" 
    	state.ExternalName = "Switch Change Over Parent"
