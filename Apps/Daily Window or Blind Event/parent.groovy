...
definition(
    name:"Daily Window or Blind Event",
    namespace: "Cobra",
    author: "Andrew Parker",
    description: "Parent App for 'Daily Window/Blind Event' childapps ",
...
def mainPage() {
	...
	display()
		...
		section (){app(name: "dailyWindowEventChild", appName: "Daily Window or Blind Event Child", namespace: "Cobra", title: "<b>Add a new automation</b>", multiple: true)}
	displayDisable()
	}
  }
}
