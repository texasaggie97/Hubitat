/**
 *  Design Usage:
 *  This is the 'Parent' app for Temperature Controlled Fan
 *
 *
 ...
 *  V1.1.0 - Debug & updated remote version checking
 *  V1.0.0 - POC
 *
 */
...
definition(
    name:"Temperature Controlled Single-Speed Fan",
    namespace: "Cobra",
    author: "Andrew Parker",
    description: "Parent App for Temperature Controlled Single-Speed ChildApps ",
...
def mainPage() {
	...
	display()
	section (){app(name: "tccFanApp1", appName: "Temperature Controlled Single-Speed Fan Child", namespace: "Cobra", title: "<b>Add a new automation</b>", multiple: true)}
	displayDisable()
	}
  }
}
...
def setVersion(){
		state.version = "1.3.0"	 
		state.InternalName = "TCCFanParent" 
    	state.ExternalName = "Temp Controlled Fan Parent"
