 ...
 *
 *  Design Usage:
 *  This was designed to control a cooling fan - Switching on/off around a desired temperature
 *
 *
 ...
 *  V1.2.0 - Added restriction page.
 *  V1.1.0 - Made parent/child and added to 'Cobra Apps'
...
definition(
    name: "Temperature Controlled Single-Speed Fan Child",
    namespace: "Cobra",
    author: "Andrew Parker",
    description: "This App was designed to control a fan - turning on/off with  varying temperatures.",
    category: "",
    
    parent: "Cobra:Temperature Controlled Single-Speed Fan",
...
def subscribeNow() {
 ...
 def mainPage() {
    ...
    section() {input "temperatureSensor1", "capability.temperatureMeasurement" , title: "Select Temperature Sensor", required: true}
	section() {
...
def setVersion(){
		state.version = "1.5.0"	 
		state.InternalName = "TCCFanChild" 
    	state.ExternalName = "Temp Controlled Fan Child"
		state.preCheckMessage = "This app is designed to control a cooling fan - Switching on/off around a desired temperature."
		state.CobraAppCheck = "tccfan.json"
}
