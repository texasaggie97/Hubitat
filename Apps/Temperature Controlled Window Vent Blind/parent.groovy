...
def mainPage() {
	...
	display()
	section (){app(name: "tempWindowVentApp", appName: "Temperature Controlled Window-Vent-Blind Child", namespace: "Cobra", title: "<b>Add a new automation</b>", multiple: true)}
	displayDisable()
	}
  }
}
