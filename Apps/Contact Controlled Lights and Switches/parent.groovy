 ...
 *  Changes:
 *
 *  V1.3.0 - Added diable apps code
 *  V1.2.0 - Moved update checking to parent
 *  V1.1.1 - Code cleanup & Debug update checking routine
...
def mainPage() {
	...
	display()
	section (){app(name: "contactChild", appName: "Contact Lights and Switches Child", namespace: "Cobra", title: "<b>Add a new automation</b>", multiple: true)}	
	displayDisable()
	}
  }
}
...
def setVersion(){
    	...
    	state.ExternalName = "Contact Switches & Lights Parent"
