 ...
 *  V1.3.0 - Moved update notifications to parent 
 *  V1.2.1 - Code cleanup & Debug update checking routine
 *  V1.2.0 - Added restrictions page 
 *  V1.1.0 - Revised update code & added 'pause' switch
 *  V1.0.0 - POC
 *
 */
...
def contactHandler (evt) {
	...
	LOGDEBUG("$contact1 = $state.contact")
...
def setVersion(){
    	...
    	state.ExternalName = "Contact Light Switches Child"
		state.preCheckMessage = "This app reacts to one or more contact sensors opening <br>You can chose to control lights or switches when a contact opens/closes"
    	state.CobraAppCheck = "contactswitchlight.json"
}
