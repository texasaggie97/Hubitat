/**
 *  Motion_Controlled_Switch/light
 *
 ...
 *  V1.2.0 - Added light control 
 *  V1.1.0 - Added restrictions page
 *  V1.0.1 - Debug - Revised update check
 *  V1.0.0 - POC
 */
 
 
definition(
    name: "Motion Controlled Switches & Lights Child",
    namespace: "Cobra",
    author: "Andrew Parker",
    description: "Turn on/off a switch or a light with a motion sensor",
    category: "Convenience",
    
parent: "Cobra:Motion Controlled Switches & Lights",
...
def mainPage() {
	...
	section(){  
        ...
        input (name: "dimLevel1", type: "number", title: "When motion starts set to this level (Optional)", required: false) 
		input (name: "dimLevel2", type: "number", title: "When motion stops set to this level (Optional - Set to 0 for off)", required: false, submitOnChange: true) 
		input (name: "delay1", type: "number", title: "Delay before switching to 'stop' level (Minutes)", required: true, defaultValue: '0') 
    	}
     }    
   }
  }
...
def setVersion(){
	...
	state.preCheckMessage = "This app is designed to turn on/off a switch or a light with a motion sensor."
		state.CobraAppCheck = "motionswitchlight.json"
}
