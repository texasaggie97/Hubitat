/**
 *  Design Usage:
 *  This is the 'Parent' app for 'Motion Controlled Switch' 
 *
 *
...
if(state.appInstalled == 'COMPLETE'){
  ...
  section (""){
		app(name: "motionSwitchApp", appName: "Motion Controlled Switch Child", namespace: "Cobra", title: "<b>Add a new automation</b>", multiple: true)
...
def installCheck(){         
  ...
  if(state.appInstalled != 'COMPLETE'){
section{paragraph "Please hit 'Done' to install 'Motion Controlled Switch'"}
  }
    else{
...
def setVersion(){
    	...
    	state.ExternalName = "Motion Controlled Switch Parent"
}
