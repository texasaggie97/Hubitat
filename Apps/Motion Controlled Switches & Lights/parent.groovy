/**
 *  Design Usage:
 *  This is the 'Parent' app for 'Motion Controlled Switches & Lights' 
 *
 *
 ...
 *  V1.1.0 - Code cleanup & Revised update checking
 *  V1.0.0 - POC
 *
 */
...
definition(
    name: "Motion Controlled Switches & Lights",
    namespace: "Cobra",
    author: "Andrew Parker",
    description: "Parent App for Motion Controlled Switch ChildApps ",
...
def mainPage() {
	...
	display()
	section (){app(name: "motionSwitchApp", appName: "Motion Controlled Switches & Lights Child", namespace: "Cobra", title: "<b>Add a new automation</b>", multiple: true)}
	displayDisable()
	}
  }
}
...
def setVersion(){
		state.version = "1.3.0"	 
		state.InternalName = "MotionSwitchParent" 
		state.CobraAppCheck = "motionswitchlight.json"
		state.ExternalName = "Motion Controlled Switches & Lights"
}
