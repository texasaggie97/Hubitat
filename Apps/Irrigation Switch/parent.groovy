 ...
 *
 *  Design Usage:
 *  This is the 'Parent' app for Irrigation Switch 
 *
 *
 ...
 *
 *
 *  V1.1.0 - Added disable apps code
 *  V1.0.0 - POC
 *
 */
...
definition(
    ...
    description: "Parent App for Irrigateion Switch ChildApps ",
...
def mainPage() {
	...
	section (){app(name: "irrigationApp", appName: "Irrigation Switch Child", namespace: "Cobra", title: "<b>Add a new automation</b>", multiple: true)}
	displayDisable()
	}
  }
}
...
def setVersion(){
		state.version = "1.1.0"	 
		state.InternalName = "IrrigationSwitchParent" 
    	state.ExternalName = "Irrigation Switch Parent"
