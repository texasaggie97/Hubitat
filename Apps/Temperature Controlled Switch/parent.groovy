/**
 *  Design Usage:
 *  This is the 'Parent' app for Temperature Controlled Switch
 *
 *
 ...
 *  Changes:
 *
 *  V1.1.0 - Added to Cobra Apps container
 *  V1.0.0 - POC
 *
 */
...
definition(
    ...
    description: "Parent App for Temperature Controlled Switch ChildApps",
...
if(state.appInstalled == 'COMPLETE'){
  ...
  section (""){
		app(name: "tempApp", appName: "Temperature Controlled Switch Child", namespace: "Cobra", title: "<b>Add a new automation</b>", multiple: true)
            }
...
def installCheck(){         
  ...
  if(state.appInstalled != 'COMPLETE'){
section{paragraph "Please hit 'Done' to install Temperature Controlled Switch "}
  }
    else{
...
def setVersion(){
		state.version = "1.1.0"	 
		state.InternalName = "TempControlledSwitchParent"
    		state.ExternalName = "Temperature Controlled Switch Parent"
}
