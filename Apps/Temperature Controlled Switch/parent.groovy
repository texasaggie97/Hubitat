...
def mainPage() {
	...
	display()
	section (){app(name: "tempApp", appName: "Temperature Controlled Switch Child", namespace: "Cobra", title: "<b>Add a new automation</b>", multiple: true)}
	displayDisable()
	}
  }
}
