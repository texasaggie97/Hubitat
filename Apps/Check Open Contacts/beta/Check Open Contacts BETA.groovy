 ...
 *
 *  Design Usage:
 *  This was designed to announce if any contacts are open when a switch turns on or a water sensor reports wet
 *
 *
    ...
    if(speechMode){ 
     ...
     section() {
 	 input "switchMode1", "bool", title: "Also Control A Switch", required: true, defaultValue: false, submitOnChange:true
         ...
         if(switchMode1 == true){
          input "switch3", "capability.switch", title: "Select Switch to control", required: false, multiple: false 
