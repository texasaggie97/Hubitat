 ...
 *  Changes:
 *
 *  V1.3.0 - Added new disable app code
...
def mainPage() {
	...
	display()
	section (){app(name: "anyOpenApp", appName: "Check Open Contacts Child", namespace: "Cobra", title: "<b>Add a new automation</b>", multiple: true)}
	displayDisable()
	}
  }
}
...
def setVersion(){
		...
		state.ExternalName = "Check Open Contacts Parent"
}
