...
display()
	...
	section() {
     ...
     section() {
		...
		section() {
            input "triggerMode", "enum", required: true, title: "Select Trigger Type", submitOnChange: true,  options: ["Button", "Mode Change", "Nest Thermostat - Heating", "Nest Thermostat - Cooling", "Switch", "Time", "Water Sensor"] 
