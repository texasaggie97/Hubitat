/**
 *  Design Usage:
 *  This is the 'Parent' app for Super Smart Fan 
 *
 *
...
definition(
    ...
    description: "Parent App for Super Smart Fan ChildApps ",
...
def mainPage() {
	...
	display()
	section (){app(name: "ssfanApp", appName: "Super Smart Fan Child", namespace: "Cobra", title: "<b>Add a new automation</b>", multiple: true)}
	displayDisable()
	}
  }
}
