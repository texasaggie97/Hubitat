 ...
 *  Changes:
 *
 *  V1.6.0 - Added disable app code
 *  V1.5.0 - Moved update check to parent
 *  V1.4.1 - Revised update check
...
def mainPage() {
	...
	display()
	section (){app(name: "weatherApp", appName: "Weather Switch Child", namespace: "Cobra", title: "Add a new weather event automation", multiple: true)}
	displayDisable()
	}
  }
}
...
def setVersion(){
		state.version = "1.6.0"	 
		state.InternalName = "WeatherSwitchParent"
