/**
 *  Design Usage:
 *  This is the 'Parent' app for Mode Switch 
 *
 *
...
if(state.appInstalled == 'COMPLETE'){
  ...
  section (""){
		app(name: "modeswitchApp", appName: "Mode Switch Child", namespace: "Cobra", title: "<b>Add a new automation</b>", multiple: true)
            }
...
def installCheck(){         
  ...
  if(state.appInstalled != 'COMPLETE'){
section{paragraph "Please hit 'Done' to install Mode Switch"}
  }
    else{
