/**
 *  Design Usage:
 *  This is the 'Parent' app for 'Did I leave Something Open' 
 *
 *
...
definition(
    name:"Did I leave Something Open",
    namespace: "Cobra",
    author: "Andrew Parker",
    description: "Parent App for 'Did I leave Something Open' childapps ",
...
def mainPage() {
	...
	display()
	section (){app(name: "leftOpenApp", appName: "Did I leave Something Open Child", namespace: "Cobra", title: "<b>Add a new automation</b>", multiple: true)}
	displayDisable()
	}
  }
}
...
def setVersion(){
		state.version = "1.0.0"	 
		state.InternalName = "LeftOpenParent" 
    	state.CobraAppCheck = "leftopen.json"
		state.ExternalName = "Did I leave Something Open Parent"
}
