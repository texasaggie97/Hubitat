 ...
 *
 * 
 *  V1.3.0 - Added app disable code
 *  V1.2.0 - Moved update checking to parent
 *  V1.1.1 - Revised version Checking
...
def mainPage() {
	...
	display()
	section (){app(name: "dailyEventChild", appName: "Daily Switch Event Child", namespace: "Cobra", title: "<b>Add a new automation</b>", multiple: true)}
	displayDisable()
	}
  }
}
...
def setVersion(){
    	...
    	state.ExternalName = "Daily Switch Event Parent" 
