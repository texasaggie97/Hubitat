/**
 * 
 *  This is the 'Parent' app for Display Tile Creator
 *
 *
...
definition(
    name:"Display Tile Creator",
    namespace: "Cobra",
    author: "Andrew Parker",
    description: "Parent App for Display Tile Creator ChildApps ",
...
def mainPage() {
	...
	section (){app(name: "tileApp", appName: "Display Tile Creator Child", namespace: "Cobra", title: "<b>Add a new child automation</b>", multiple: true)}
	displayDisable()
	}
  }
}
...
def setVersion(){
		state.version = "1.0.0"	 
		state.InternalName = "TileCentralParent" 
    	state.ExternalName = "Tile Central Parent"
