/**
 * 
 *  This is the 'Parent' app for Tile Central 
 *
 *
...
definition(
    ...
    description: "Parent App for Tile Central ChildApps ",
...
def mainPage() {
	...
	section (){app(name: "tileApp", appName: "Tile Central Child", namespace: "Cobra", title: "<b>Add a new child automation</b>", multiple: true)}
	displayDisable()
	}
  }
}
